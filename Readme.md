...
> 生成日期：2026-06-08  
> 基于完整代码阅读（backend + frontend + tests）+ git 历史分析
...
|---|---|---|---|---|---|---|
| **adam / 沫路**（同一人） | 95 | ~28,200 | 47 | 33 | **~45%** | 项目架构师：全栈核心 + Prompt 工程 |
| **Wang / Uzemiu**（同一人） | 89 | ~11,500 | 45 | 23 | **~30%** | 前端 UI + 交互功能 |
| **Musuyin** | 45 | ~5,200 | 16 | 17 | **~20%** | 后端特性 + 全链路打通 |
| **nevergottagiveyouup** | 14 | — | 3 | 0 | ~3% | — |
| **Lvsheng Wu** | 6 | — | 3 | 0 | ~2% | — |
