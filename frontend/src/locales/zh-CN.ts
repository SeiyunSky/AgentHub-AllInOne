export default {
  ...
  agentForm: {
    ...
    platformClaudeDesc: '通过 Claude Code CLI 运行，支持本地工具',
    platformAnthropicSdkLabel: 'Anthropic SDK',
    platformAnthropicSdkDesc: '直接调用 Anthropic API，支持 MCP 服务连接',
    skillsLabel: 'Skills',
    ...
    addMoreMcpServers: '添加更多 MCP 服务器',
    selectMcpServers: '选择 MCP 服务器',
    loadingMcpServers: '加载中...',
    noMcpServersAvailable: '暂无可用 MCP 服务器',
  },
  ...
  mcpDialog: {
    ...
    serverIdPlaceholder: '如 time、fetch、github',
    serverIdHint: '在该 Agent 内唯一标识，创建后不可修改',
    transportLabel: '连接方式',
    commandLabel: '命令 (command)',
    commandPlaceholder: '如 uvx、npx',
    argsLabel: '参数 (args)',
    argsPlaceholder: '输入参数后按 Enter 或点击 +',
    envLabel: '环境变量 (env)',
    urlLabel: '服务器 URL',
    urlPlaceholder: 'https://mcp-server.example.com/sse',
    headersLabel: '请求头 (headers)',
    headerKeyPlaceholder: '如 Authorization',
    headerValuePlaceholder: '如 Bearer token',
    testConnection: '测试连通性',
    testOk: '连接成功',
    testFail: '连接失败',
    toolsFound: '发现 {count} 个工具',
    noToolsFound: '连接成功，未发现工具',
    testFailed: '测试请求失败',
    serverIdRequired: 'Server ID 不能为空',
    commandRequired: 'stdio 模式需填写 command',
    urlRequired: 'SSE 模式需填写 URL',
  },
  ...
  mcpServersPanel: {
    ...
    emptyDesc: '创建你的第一个 MCP 服务器，为 Agent 接入外部工具能力。',
  ...
  mcpServerForm: {
    ...
    descriptionLabel: '描述',
    descriptionPlaceholder: '简要描述此 MCP 服务器的用途...',
    transportLabel: '连接方式',
    commandLabel: '命令 (command)',
    commandPlaceholder: '如 uvx、npx',
    argsLabel: '参数 (args)',
    argsPlaceholder: '在此添加参数…',
    addArg: '添加参数',
    envLabel: '环境变量 (env)',
    addEnvVar: '添加变量',
    urlLabel: '服务器 URL',
    ...
    addHeader: '添加 Header',
    visibilityLabel: '可见性',
    publicServer: '公开 MCP 服务器',
    publicServerDesc: '允许其他用户发现并使用此 MCP 服务器',
    statusLabel: '状态',
    activeLabel: '活跃',
    disabledServerDesc: '已禁用的 MCP 服务器无法被 Agent 使用',
  },
  ...
  mcpServerFormPanel: {
    ...
    readonlyTag: '（只读）',
    readonlyBuiltin: '内置 MCP 服务器不可修改',
    readonlyOther: '无权修改他人创建的 MCP 服务器',
    delete: '删除',
    cancel: '取消',
    saveChanges: '保存修改',
    createServer: '新建 MCP 服务器',
    loadFailed: '加载 MCP 服务器失败',
    deleteConfirm: '确认删除 MCP 服务器 "{name}"？此操作不可恢复。',
    deleteTitle: '删除 MCP 服务器',
    deleted: 'MCP 服务器已删除',
    deleteFailed: '删除失败',
    nameRequired: 'MCP 服务器名称不能为空',
    commandRequired: 'stdio 模式需填写 command',
    urlRequired: 'SSE / Streamable HTTP 模式需填写 URL',
    created: 'MCP 服务器已创建',
    saveFailed: '保存失败',
    testConnection: '测试连通性',
    testOk: '连接成功',
