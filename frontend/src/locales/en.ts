export default {
  ...
  agentForm: {
    ...
    platformClaudeLabel: 'Claude CLI',
    platformClaudeDesc: 'Runs via Claude Code CLI, supports local tools',
    platformAnthropicSdkLabel: 'Anthropic SDK',
    platformAnthropicSdkDesc: 'Direct Anthropic API call, supports MCP server connections',
    skillsLabel: 'Skills',
    ...
    addMoreMcpServers: 'Add more MCP Servers',
    selectMcpServers: 'Select MCP Servers',
    loadingMcpServers: 'Loading...',
  ...
  mcpDialog: {
    ...
    serverIdPlaceholder: 'e.g. time, fetch, github',
    serverIdHint: 'Unique within this agent; cannot be changed after creation',
    transportLabel: 'Transport',
    commandLabel: 'Command',
    commandPlaceholder: 'e.g. uvx, npx',
    argsLabel: 'Arguments (args)',
    argsPlaceholder: 'Type an arg and press Enter or +',
    envLabel: 'Environment variables (env)',
    urlLabel: 'Server URL',
    urlPlaceholder: 'https://mcp-server.example.com/sse',
    ...
    noToolsFound: 'Connected — no tools found',
    testFailed: 'Test request failed',
    serverIdRequired: 'Server ID is required',
    commandRequired: 'stdio mode requires a command',
    urlRequired: 'SSE mode requires a URL',
  },
  ...
  mcpServersPanel: {
    ...
    emptyDesc: 'Create your first MCP server to connect agents to external tools.',
    createServer: 'Create MCP Server',
    noDescription: 'No description',
    tooltipActive: 'Active',
    tooltipInactive: 'Disabled',
    filterAll: 'All',
    filterActive: 'Active',
  ...
  mcpServerForm: {
    ...
    commandPlaceholder: 'e.g. uvx, npx',
    argsLabel: 'Arguments (args)',
    argsPlaceholder: 'Add an argument…',
    addArg: 'Add argument',
    envLabel: 'Environment variables (env)',
    ...
    visibilityLabel: 'Visibility',
    publicServer: 'Public MCP Server',
    publicServerDesc: 'Allow other users to discover and use this MCP server',
    statusLabel: 'Status',
    activeLabel: 'Active',
    disabledServerDesc: 'Disabled MCP servers cannot be used by agents',
  },
  ...
  mcpServerFormPanel: {
    ...
    readonlyTag: '(Read-only)',
    readonlyBuiltin: 'Built-in MCP servers cannot be modified',
    readonlyOther: 'You do not have permission to modify this MCP server',
    delete: 'Delete',
    cancel: 'Cancel',
    saveChanges: 'Save Changes',
    createServer: 'Create MCP Server',
    loadFailed: 'Failed to load MCP server',
    ...
    commandRequired: 'stdio mode requires a command',
    urlRequired: 'SSE / Streamable HTTP mode requires a URL',
